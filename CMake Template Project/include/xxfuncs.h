...
/* XXDelay is model specific and therefore implemented in %SUBMODEL_NAME%.cpp */
/* XXInitialValue is model specific and therefore implemented in %SUBMODEL_NAME%.cpp */
...
/* XXStopSimulation is implemented in %SUBMODEL_NAME%.cpp */
