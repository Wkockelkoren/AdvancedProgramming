...
class Submodel20sim
{
	protected:
		...
		bool %VARPREFIX%%XX_INITIALIZE%;
		bool %VARPREFIX%major;
		bool %VARPREFIX%stop_run;
	...
	public:
		...
		XXDouble GetStepSize(void) { return %VARPREFIX%%XX_TIME%; };
		XXDouble GetStartTime(void) { return %VARPREFIX%start_time; };
		XXDouble GetFinishTime(void) { return %VARPREFIX%finish_time; };
		XXDouble GetTime(void) { return %VARPREFIX%%XX_TIME%; };
